package mx.random.cms.web{
	...
	import mx.random.cms.UserData;
	import mx.random.cms.events.LogoutEvent;
	import mx.random.cms.userAuth.User;
	...
	public class WebApplication extends EventDispatcher {
		...
		private function loginResult(event:ResultEvent):void{
			...
			if(event.result.paths){
				...
				UserData.UP_PATH = event.result.paths.upl;
